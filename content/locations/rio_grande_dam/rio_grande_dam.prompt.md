...
type: background
size: 1280x768
source: docs/lore/districts/los_andes/landmarks/rio_grande_dam/rio_grande_dam.md
target: `scene.background_url` in `content/locations/location_rio_grande_dam.yaml`
consumer: background
---
