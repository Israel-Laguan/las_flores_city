---
name: Parque de Atracciones Las Flores
type: background
size: 1280x768
source: docs/lore/districts/port/parque_de_atracciones_las_flores/parque_de_atracciones_las_flores.md
target: `scene.background_url` in `content/districts/port/locations/parque_de_atracciones_las_flores/location_parque_de_atracciones_las_flores.yaml`
consumer: html-background
---

# Prompt: Parque de Atracciones Las Flores

**Tool:** NIM (draft) → Flux/Seedance (refine)
**Pipeline stage:** draft → refine

## Prompt (Draft)
Parque de Atracciones Las Flores in Las Flores, daytime establishing shot, urban Latin American setting. Warm natural light, grounded human-scale architecture, desaturated editorial palette. No people, no text, no logos. photorealistic portrait, hyper-detailed, 8k. NO photorealistic, 3D render, anime, cartoon, text, watermarks, blurry, low quality.

## Prompt
Parque de Atracciones Las Flores in Las Flores, establishing wide shot, premium contemporary graphic novel realism, refined editorial line art illustration, painterly soft shading, muted desaturated colors, smooth gradients, crisp rendering, minimal surface texture, ultra-clean 4k. No people, no text, no logos.
