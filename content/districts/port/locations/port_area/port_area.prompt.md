...
type: background
size: 1280x768
source: docs/lore/districts/port/landmarks/port_area/port_area.md
target: `scene.background_url` in `content/locations/location_port_area.yaml`
...
- [ ] Night version: Port Area after dark — The Port Area of Las Flores is a vibrant and bustling commer...
- [ ] Rainy version: Port Area in the rain — wet surfaces, reflected neon, moody atmosphere,  featuring Puerto de Las Flores and Public Squares
- [ ] Wide shot: wider establishing view of Port Area including  featuring Puerto de Las Flores and Public Squares, broader environmental context
