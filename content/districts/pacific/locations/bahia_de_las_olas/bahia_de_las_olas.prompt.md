---
name: Bahía de las Olas
type: background
size: 1280x768
source: docs/lore/districts/pacific/landmarks/bahia_de_las_olas/bahia_de_las_olas.md
target: `scene.background_url` in `content/locations/location_bah_a_de_las_olas.yaml`
consumer: background
---
