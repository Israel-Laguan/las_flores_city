...
type: background
size: 1280x768
source: docs/lore/districts/isla_de_oro/isla_de_oro.md
target: `scene.background_url` in `content/locations/location_isla_de_oro.yaml`
