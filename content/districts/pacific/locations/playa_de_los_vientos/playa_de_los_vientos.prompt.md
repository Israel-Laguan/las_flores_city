...
type: background
size: 1280x768
source: docs/lore/districts/pacific/landmarks/playa_de_los_vientos/playa_de_los_vientos.md
target: `scene.background_url` in `content/locations/location_playa_de_los_vientos.yaml`
consumer: background
---
