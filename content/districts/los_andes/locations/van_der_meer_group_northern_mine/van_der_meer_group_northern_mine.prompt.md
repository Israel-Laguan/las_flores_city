---
name: Van der Meer Group Northern Mine
type: background
size: 1280x768
source: docs/lore/districts/los_andes/landmarks/van_der_meer_group_northern_mine/van_der_meer_group_northern_mine.md
target: `scene.background_url` in `content/locations/location_van_der_meer_group_northern_mine.yaml`
consumer: background
---
