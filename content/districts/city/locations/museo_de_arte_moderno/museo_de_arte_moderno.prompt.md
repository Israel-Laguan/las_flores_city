...
type: background
size: 1280x768
source: docs/lore/districts/city/museo_de_arte_moderno/museo_de_arte_moderno.md
target: `scene.background_url` in `content/districts/city/locations/museo_de_arte_moderno/location_museo_de_arte_moderno.yaml`
consumer: html-background
---

# Prompt: Museo de Arte Moderno

**Tool:** NIM (draft) → Flux/Seedance (refine)
**Pipeline stage:** draft → refine

## Prompt (Draft)
Museo de Arte Moderno in Las Flores, daytime establishing shot, urban Latin American setting. Warm natural light, grounded human-scale architecture, desaturated editorial palette. No people, no text, no logos. photorealistic portrait, hyper-detailed, 8k. NO photorealistic, 3D render, anime, cartoon, text, watermarks, blurry, low quality.

## Prompt
Museo de Arte Moderno in Las Flores, establishing wide shot, premium contemporary graphic novel realism, refined editorial line art illustration, painterly soft shading, muted desaturated colors, smooth gradients, crisp rendering, minimal surface texture, ultra-clean 4k. No people, no text, no logos.
