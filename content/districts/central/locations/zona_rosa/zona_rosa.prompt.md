...
type: background
size: 1280x768
source: docs/lore/districts/city/landmarks/zona_rosa/zona_rosa.md
target: `scene.background_url` in `content/locations/location_zona_rosa.yaml`
...
- [ ] Night version: Zona Rosa after dark — During the day, Zona Rosa transforms into a tranquil, almost...
- [ ] Rainy version: Zona Rosa in the rain — wet surfaces, reflected neon, moody atmosphere
- [ ] Wide shot: wider establishing view of Zona Rosa, broader environmental context
