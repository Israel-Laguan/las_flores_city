---
name: Sierra Verde Park
type: background
size: 1280x768
source: docs/lore/districts/southeast/landmarks/sierra_verde_park/sierra_verde_park.md
target: `scene.background_url` in `content/locations/location_sierra_verde_park.yaml`
...
- [ ] Night version: Sierra Verde Park after dark — Sierra Verde Park is nestled within the cityscape in the sou...
- [ ] Rainy version: Sierra Verde Park in the rain — wet surfaces, reflected neon, moody atmosphere,  featuring Walking Trails and Picnic Areas
- [ ] Wide shot: wider establishing view of Sierra Verde Park including  featuring Walking Trails and Picnic Areas, broader environmental context
