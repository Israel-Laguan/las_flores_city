...
source: content/characters/elena_ramirez/elena_ramirez.prompt.md
target: content/characters/elena_ramirez/assets/
---

# Video Prompts: Elena Ramirez

Generate seamless looping portrait videos from each expression variant PNG. Use the corresponding `elena_ramirez__<expression>.png` as the input image for each prompt. The woman on the reference image is the character described in the source prompt file.
