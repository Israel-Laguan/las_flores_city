...
**Type:** portrait
**Source:** content/characters/isabella_garcia/isabella_garcia.md
**Target field:** `asset_paths.portrait` in `content/characters/isabella_garcia/char_isabella_garcia.yaml`
...
- **`__happy.png`**: Use the base portrait as reference. A faint, warm smile, looking at the camera, 3/4 take. Deep-set eyes soften and crinkle at the corners, full lips curve up gently, the pallor lifting into a muted glow. Arched brows relaxed. Sunlit window light warms the modest studio. Keep the same art style as reference, same casual clothes and earbud: premium contemporary graphic novel realism, refined editorial line art illustration. Clean confident linework, painterly soft shading, muted natural palette.

- **`__vulnerable.png`**: Use the base portrait as reference. A raw, open expression, looking at the camera, 3/4 take. Deep-set eyes larger and unprotected, full lips slightly parted, shoulders soft under her paint-stained clothes. The faint bluish under-eye circles and wrist scar visible. Soft, diffused studio light. Keep the same art style as reference, same sketchbook and earbud: premium contemporary graphic novel realism, refined editorial line art illustration. Clean confident linework, painterly soft shading, muted natural palette.

- **`__determined.png`**: Use the base portrait as reference. A quiet resilience, looking at the camera, 3/4 take. Deep-set eyes steady and focused, full lips pressed in a firm line, chin lifted, heart-shaped face composed. Wavy dark hair tucked behind an ear. Studio light sharpening over the canvases. Keep the same art style as reference, same clothing and earbud: premium contemporary graphic novel realism, refined editorial line art illustration. Clean confident linework, painterly soft shading with clearer shadows, muted natural palette.
