...
- **`__afraid.png`**: Use the base portrait as reference. Lingering guarded fear, looking at the camera, 3/4 take. Wide-set eyes widened with unease, thick brows drawn up, thin lips held tight. Deep worry lines pronounced across the brow. Long face tense, slight tremor more visible in his hands. Dimmer lamplight casting long shadows on the diagramed wall. Keep the same art style as reference, same clothing and spectacles. Clean confident linework, painterly soft shading, muted natural palette.

- **`__determined.png`**: Use the base portrait as reference. Quiet resolve after years of silence, looking at the camera, 3/4 take. Wide-set eyes steady, thin lips set firm, receding jawline squared. Deep worry lines eased into resolve. White hair and spectacles catching warm light. Blueprint backdrop clearer and more confident in tone. Keep the same art style as reference, same cardigan and earbud. Clean confident linework, painterly soft shading with stronger shadows, muted natural palette.

- **`__sad.png`**: Use the base portrait as reference. Quiet sorrow, looking at the camera, 3/4 take. Wide-set eyes shadowed with regret, deep worry lines heavy, full-lined lips drawn down. Long face softened, receding jawline relaxed. Frayed collar and spectacles under dim, mournful lamplight. Keep the same art style as reference, same clothing and earbud. Clean confident linework, painterly soft shading, muted natural palette.
