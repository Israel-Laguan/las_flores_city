...
> Tags: `#figure` `#npc` `#neutral` `#old_town` `#barista`

## Overview

**Born:** ~2029
**Age (2077):** 48
**Role:** Café Owner & Neighborhood Fixture
**Status:** Alive

## Physical Description
- Hair: Dark, greying at the temples and streaks throughout
- Eyes: Warm brown, crinkled at the corners from years of smiling
- Build: Stocky and solid, comfortable in his own skin
- Skin: Warm brown
- Distinguishing features: Nearly always wearing a practical canvas apron, hands show the calluses and faint burn marks of decades working espresso machines.

## Background
Marco is the second-generation owner of the Old Town Cafe, a beloved fixture in one of Las Flores's rapidly gentrifying districts. His mother opened the cafe decades ago, and Marco practically grew up behind the counter. He has watched Old Town change from a vibrant, messy community into a targeted zone for corporate buyouts and high-end redevelopment. Despite the pressure to sell out, Marco has held his ground, treating his cafe as a sanctuary for the neighborhood's old soul. 
...
## Content Reference
- Dev Mode character file: `content/characters/marco_restrepo/char_marco_restrepo.yaml`
