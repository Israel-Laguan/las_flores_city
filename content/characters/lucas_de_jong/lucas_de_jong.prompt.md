...
- **`__calculating.png`**: Use the base portrait as reference. He is sizing up the room, looking at the camera with a sharp, measuring gaze, 3/4 take. Wide-set piercing blue eyes narrowed, thin lips pressed into a flat line, brows leveling into scrutiny. Angular face, strong jawline set. Stylishly cut dark hair, clear skin. Upscale lounge backdrop with steady directional light. Keep the same art style as reference, same fashionable clothing and earbud. Clean confident linework, painterly soft shading, muted natural palette.

- **`__happy.png`**: Use the base portrait as reference. A bright, easy smile, looking at the camera, 3/4 take. Wide-set piercing blue eyes warm and crinkled, the small front-tooth chip showing in an open grin. Angular face relaxed, strong jawline softened. Stylishly cut dark hair, athletic build at ease. Upscale lounge backdrop brightened and warm. Keep the same art style as reference, same designer outfit and earbud. Clean confident linework, painterly soft shading, muted natural palette.

- **`__afraid.png`**: Use the base portrait as reference. A guarded, wary moment, looking at the camera, 3/4 take. Wide-set piercing blue eyes widened, brows drawn up, thin lips pressed tight, the composed facade cracking. Angular face tense, strong jawline clenched. Stylishly cut dark hair falling forward. Upscale lounge backdrop dimmed and shadowed. Keep the same art style as reference, same clothing and earbud. Clean confident linework, painterly soft shading with deeper shadow, muted natural palette.
