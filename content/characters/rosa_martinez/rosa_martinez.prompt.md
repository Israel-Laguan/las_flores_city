...
- **`rosa_martinez__contemplative.png`**: Use the base portrait as reference. A satisfied pause, looking at the camera, 3/4 take. Dark eyes softening, lips relaxed, satisfaction in a moment of rest. Keep the same art style as reference, same earbud and clothing, same backdrop. Clean confident linework, painterly soft shading, muted natural palette.
