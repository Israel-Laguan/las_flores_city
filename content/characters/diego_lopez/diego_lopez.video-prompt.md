...
source: content/characters/diego_lopez/diego_lopez.prompt.md
target: content/characters/diego_lopez/assets/
---

# Video Prompts: Diego López

Generate seamless looping portrait videos from each expression variant PNG. Use the corresponding `diego_lopez__<expression>.png` as the input image for each prompt. The man on the reference image is the character described in the source prompt file.
