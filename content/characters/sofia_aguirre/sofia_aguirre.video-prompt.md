...
source: content/characters/sofia_aguirre/sofia_aguirre.prompt.md
target: content/characters/sofia_aguirre/assets/
---

# Video Prompts: Sofia Aguirre

Generate seamless looping portrait videos from each expression variant PNG. Use the corresponding `sofia_aguirre__<expression>.png` as the input image for each prompt. The woman on the reference image is the character described in the source prompt file.

## Base Loop (Default)

**Input**: `assets/sofia_aguirre__default.png`
...
**Input**: `assets/sofia_aguirre__focused.png`
...
**Input**: `assets/sofia_aguirre__happy.png`
...
**Input**: `assets/sofia_aguirre__determined.png`
...
**Input**: `assets/sofia_aguirre__contemplative.png`
