...
source: content/characters/robert_thompson/robert_thompson.prompt.md
target: content/characters/robert_thompson/assets/
---

# Video Prompts: Robert Thompson

Generate seamless looping portrait videos from each expression variant PNG. Use the corresponding `robert_thompson__<expression>.png` as the input image for each prompt. The man on the reference image is the character described in the source prompt file.

## Base Loop (Default)

**Input**: `assets/robert_thompson__default.png`
...
**Input**: `assets/robert_thompson__calculating.png`
...
**Input**: `assets/robert_thompson__happy.png`
