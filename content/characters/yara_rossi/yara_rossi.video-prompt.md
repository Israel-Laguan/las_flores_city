...
source: content/characters/yara_rossi/yara_rossi.prompt.md
target: content/characters/yara_rossi/assets/
---

# Video Prompts: Yara Rossi

Generate seamless looping portrait videos from each expression variant PNG. Use the corresponding `yara_rossi__<expression>.png` as the input image for each prompt. The woman on the reference image is the character described in the source prompt file.

## Base Loop (Default)

**Input**: `assets/yara_rossi__default.png`
