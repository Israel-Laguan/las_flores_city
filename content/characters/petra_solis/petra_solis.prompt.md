...
- **`petra_solis__default.png`**: Use the base portrait as reference. Carefully managed warm-but-guarded expression, looking slightly off-camera, 3/4 take. Keep the same art style as reference, same clothing and backdrop. Clean confident linework with vector-like cleanliness, painterly soft shading, muted natural palette.

- **`petra_solis__calculating.png`**: Use the base portrait as reference. The cold, calculating reality beneath the persona, looking intensely at the camera, 3/4 take. Eyes narrowed and sharp, the practiced smile gone, lips pressed in a thin, assessing line. The pause before she speaks — already three moves ahead. Keep the same art style as reference, same suit and styling, government office lighting. Clean confident linework with vector-like cleanliness, painterly soft shading, muted natural palette.
