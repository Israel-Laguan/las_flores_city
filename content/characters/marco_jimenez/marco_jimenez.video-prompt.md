...
source: content/characters/marco_jimenez/marco_jimenez.prompt.md
target: content/characters/marco_jimenez/assets/
---

# Video Prompts: Marco Jiménez

Generate seamless looping portrait videos from each expression variant PNG. Use the corresponding `marco_jimenez__<expression>.png` as the input image for each prompt. The man on the reference image is the character described in the source prompt file.

## Base Loop (Default)

**Input**: `assets/marco_jimenez__default.png`
...
**Input**: `assets/marco_jimenez__determined.png`
...
**Input**: `assets/marco_jimenez__calculating.png`
...
**Input**: `assets/marco_jimenez__contemplative.png`
