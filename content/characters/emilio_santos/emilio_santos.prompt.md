...
- **`__determined.png`**: Use the base portrait as reference. He has a briefly resolved expression, looking unflinchingly at the camera, 3/4 take. Dark brown eyes flashing with old ambition, jaw squared. Dark brown hair slicked back, five o'clock shadow sharp. Expensive watch prominent, gold chain hidden. Medium height broad-shouldered build squared. Cheap linen shirt buttoned. Beach house terrace backdrop with strong directional light. Keep the same art style as reference, same linen shirt. Clean confident linework, painterly soft shading, muted natural palette.

- **`__vulnerable.png`**: Use the base portrait as reference. He has a quietly broken expression, looking gently at the camera, 3/4 take. Dark brown eyes open and honest, haunted, the mask finally gone. Dark brown hair loose, five o'clock shadow prominent. Cheap linen shirt hanging open, gold chain visible. Broad-shouldered frame sagging. Beach house terrace backdrop under soft, forgiving twilight. Keep the same art style as reference, same linen shirt. Clean confident linework, painterly soft shading, muted natural palette.

- **`__angry.png`**: Use the base portrait as reference. He has a flushed, angry expression, looking at the camera, 3/4 take. Dark brown eyes blazing with old resentments, jaw set. Dark brown hair slicked back, five o'clock shadow sharp. Gold chain prominent, expensive watch catching light. Medium height broad-shouldered build tense. Cheap linen shirt open at the collar. Beach house terrace backdrop under harsh overhead light. Keep the same art style as reference, same linen shirt. Clean confident linework, painterly soft shading, muted natural palette.
