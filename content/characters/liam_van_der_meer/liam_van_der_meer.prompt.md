...
- **`__smirk.png`**: Use the base portrait as reference. A faint, self-satisfied half-smile plays across his face, looking at the camera, 3/4 take. Deep-set eyes glinting with private confidence, the thin lips curled at one corner, the lower brow lending a knowing tilt. The scar near his left ear is visible. City skyline light frames him. Keep the same art style as reference, same clothing and earbud. Clean confident linework, painterly soft shading, muted natural palette.

- **`__determined.png`**: Use the base portrait as reference. He is fixed on an objective, looking unflinchingly at the camera, 3/4 take. Deep-set eyes locked and cold, thin lips set, thick brows firm. The soft jawline settles into resolve. Boardroom glass sharpens the light behind him. Keep the same art style as reference, same suit and pin. Clean confident linework, painterly soft shading, muted natural palette.

- **`__surprised.png`**: Use the base portrait as reference. Caught off guard, looking at the camera with sudden alertness, 3/4 take. Deep-set eyes widened, thick brows shot up, thin lips parted. The scar near his left ear and gray threading read clearly. Boardroom light flares momentarily. Keep the same art style as reference, same clothing and earbud. Clean confident linework, painterly soft shading, muted natural palette.
