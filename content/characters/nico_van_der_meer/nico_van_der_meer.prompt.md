...
- **`__smirk.png`**: Use the base portrait as reference. A faint, wry knowing curl, looking at the camera, 3/4 take. Thin lips pulled into a slight half-smile, deep-set eyes glinting with quiet ambition. One brow naturally lower gives the smirk an ironic edge. Warehouse backdrop with stacked crates, industrial light. Keep the same art style as reference, same attire and earbud. Clean confident linework, painterly soft shading, muted natural palette.

- **`__determined.png`**: Use the base portrait as reference. A firm, resolute expression, looking at the camera, 3/4 take. Deep-set eyes steady and unyielding, strong jaw set, thick brows grounded in resolve. Gray-templed blonde hair neat, shoulders squared in the athletic build. Port warehouse backdrop with shipping containers. Keep the same art style as reference, same attire and earbud. Clean confident linework, painterly soft shading with deeper shadows, muted natural palette.

- **`__afraid.png`**: Use the base portrait as reference. A guarded, controlled unease, looking at the camera, 3/4 take. Deep-set eyes slightly widened, thin lips taut, the small scar on his left brow reading as tension. Gray-templed hair catching harsher light, warehouse shadows deepening behind him. Keep the same art style as reference, same attire and earbud. Clean confident linework, painterly soft shading, muted natural palette.
