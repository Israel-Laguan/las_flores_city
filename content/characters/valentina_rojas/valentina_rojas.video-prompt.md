...
source: content/characters/valentina_rojas/valentina_rojas.prompt.md
target: content/characters/valentina_rojas/assets/
---

# Video Prompts: Valentina Rojas

Generate seamless looping portrait videos from each expression variant PNG. Use the corresponding `valentina_rojas__<expression>.png` as the input image for each prompt. The woman on the reference image is the character described in the source prompt file.

## Base Loop (Default)

**Input**: `assets/valentina_rojas__default.png`
...
**Input**: `assets/valentina_rojas__determined.png`
