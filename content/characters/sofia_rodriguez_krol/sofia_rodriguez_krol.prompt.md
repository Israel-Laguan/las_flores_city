...
- **`sofia_rodriguez_krol__default.png`**: Use the base portrait as reference. Calm determined resting expression, looking at the camera, 3/4 take. Keep the same art style as reference, same clothing and backdrop. Clean confident linework, painterly soft shading, muted natural palette, zero conventional beauty templates, grounded human anatomy with natural asymmetry.

- **`sofia_rodriguez_krol__focused.png`**: Use the base portrait as reference. Absorbed in creative work on a painting or sketch, looking at the camera, 3/4 take. Eyes intent and narrowed, brows knit, lips pressed in concentration. Keep the same art style as reference, same earbud and work clothing. Clean confident linework, painterly soft shading, muted natural palette.

- **`sofia_rodriguez_krol__contemplative.png`**: Use the base portrait as reference. Gazing at her finished work, contemplating its emotional impact, looking at the camera, 3/4 take. Eyes softening into the middle distance, lips relaxed, head tilted. Keep the same art style as reference, same earbud and work clothing, studio backdrop. Clean confident linework, painterly soft shading, muted natural palette.

- **`sofia_rodriguez_krol__happy.png`**: Use the base portrait as reference. A warm, genuine smile, looking at the camera, 3/4 take. Eyes brightening, cheeks lifting, the composed bearing warming. Keep the same art style as reference, same earbud and work clothing, same backdrop. Clean confident linework, painterly soft shading, muted natural palette.
