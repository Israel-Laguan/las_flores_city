---
name: The Retirement Complex Murders (2058–2077)
type: story-illustration
size: 1920x1080
source: content/lore/stories/retirement_complex_murders/retirement_complex_murders.md
target: `assets/retirement_complex_murders__default.png`
...
## Variations
- [ ] Wide shot from across the river, the complex small against the water, Evelyn a tiny silhouette at the property edge
- [ ] Close-up on Evelyn's face in the streetlamp pool, the building entrance blurred in background, her eyes tracking movement inside
