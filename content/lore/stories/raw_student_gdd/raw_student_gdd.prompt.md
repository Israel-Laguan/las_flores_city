---
name: Prologue: The Seed and The Trial (2053)
type: story-illustration
size: 1920x1080
source: content/lore/stories/raw_student_gdd/raw_student_gdd.md
target: `assets/raw_student_gdd__default.png`
...
## Variations
- [ ] Shot from the boulevard looking down the alley, the two women small in the depth of the frame, the crowd passing by above
- [ ] Close-up on the wounded woman's face, pain and defiance mixed, the student's blurred shoulder in the foreground edge
