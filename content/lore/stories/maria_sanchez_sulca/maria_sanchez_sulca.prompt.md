---
name: Maria Sanchez Sulca - The Whistleblower
type: story-illustration
size: 1920x1080
source: content/lore/stories/maria_sanchez_sulca/maria_sanchez_sulca.md
target: `assets/maria_sanchez_sulca__default.png`
...
## Variations
- [ ] Overhead shot of the kitchen table, documents covering every surface, Maria's hand with the red pen as the only human element
- [ ] Close-up on Maria's face, documents blurred in the foreground, a single document edge reading "Minera Estrella" visible in soft focus
