---
name: Ricardo Vega - Party Hopper
type: story-illustration
size: 1920x1080
source: content/lore/stories/ricardo_vega/ricardo_vega.md
target: `assets/ricardo_vega__default.png`
...
## Variations
- [ ] Close-up on the newspaper on the counter, Ricardo's name at the bottom of the results, the candy jar and his hand blurred in the foreground
- [ ] Shot from the street looking in through the window, Ricardo small inside the store, the industrial district visible behind the glass
