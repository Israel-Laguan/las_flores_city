---
name: Van der Meer Dynasty's Unconventional Love
type: story-illustration
size: 1920x1080
source: content/lore/stories/van_der_meer_lgbtq_legacy/van_der_meer_lgbtq_legacy.md
target: `assets/van_der_meer_lgbtq_legacy__default.png`
...
## Variations
- [ ] Close-up on Peter's face, relief and authenticity visible, the garden party blurred in soft background, Jan Jr.'s shoulder in the edge of frame
- [ ] Wide shot from the garden edge, the party spread across the lawn, Peter small but centered at the archway, the estate facade behind
