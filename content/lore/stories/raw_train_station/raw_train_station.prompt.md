---
name: DEMO Story: Train Station Protest and Alley Incident
type: story-illustration
size: 1920x1080
source: content/lore/stories/raw_train_station/raw_train_station.md
target: `assets/raw_train_station__default.png`
...
## Variations
- [ ] Wide shot from the station's upper balcony, the student, protest crowd, and alley entrance visible as a single dense scene
- [ ] Close-up on the student's face, pamphlets in hand, torn between joining the protest and investigating the alley
