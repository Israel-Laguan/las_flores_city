---
name: Why are Police More Present in Rich Neighborhoods? And Who's Protecting the Poor?
type: story-illustration
size: 1920x1080
source: content/lore/stories/policing_disparity_exposed/policing_disparity_exposed.md
target: `assets/policing_disparity_exposed__default.png`
...
## Variations
- [ ] High-angle shot from a nearby rooftop, the two districts visible as a single patchwork of protection and neglect
- [ ] Ground-level view from the Barrio Viejo side, looking across the curb toward the Villa Dorada officer on bicycle patrol
