...
export const options = {
  ...
  thresholds: {
    custom_req_duration:  ['p(95)<150'], // P95 latency must stay below 150ms
...
// via: server/scripts/seed_load_test_users.ts (not yet implemented)
...
export default function () {
  ...
  // Uses a fixed character ID present in seeded content
  const diagStartRes = http.post(
    `${BASE_URL}/dialogue/start`,
    JSON.stringify({ characterId: '123e4567-e89b-12d3-a456-426614174000' }),
    {
      headers: {
