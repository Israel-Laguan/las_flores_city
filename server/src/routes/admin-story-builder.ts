...
adminStoryBuilderRouter.post('/plans/:id/items/:itemId/lore', async (req: AuthRequest, res) => {
  try {
    ...
    const provider = contentPlanService['provider']; // Access private provider (for now)
