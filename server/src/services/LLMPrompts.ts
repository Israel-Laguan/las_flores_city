...
export function formatExistingContent(context: ExistingContentContext): {
...
// ── Intake Conflict & Fill Prompts ────────────────────────────────────────
// Implementation lives in llmPromptsExtra.ts.
export {
  buildIntakeConflictPrompt,
  buildFillFieldsPrompt,
} from './llmPromptsExtra.js';
