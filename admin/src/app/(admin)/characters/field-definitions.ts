...
const IDENTITY_FIELDS: FieldDef[] = [
  { key: "id", label: "ID", type: "text", readOnly: true, section: "Identity" },
...
const ASSET_PATH_FIELDS: FieldDef[] = [
  ...
  {
    key: "asset_paths.expression_strip",
...
const SYSTEM_VIEW_FIELDS: FieldDef[] = [
  {
    key: "created_at",
    label: "Created",
    type: "text",
...
const SYSTEM_EDIT_FIELDS: FieldDef[] = [
  { key: "id", label: "ID", type: "text", readOnly: true, section: "System" },
  {
    key: "lore_path",
    label: "Lore Path",
    type: "text",
  ...
  ...make(
    [
      ...
      },
      {
        ...
        label: "Outfits",
        type: "array-of-objects",
        itemFields: MANIFEST_OUTFIT_FIELDS,
      },
