  ...
  return (
    <main style={styles.main}>
      ...
      <div style={styles.section}>
        ...
        <h2 style={styles.sectionHeading}>Admin & Player Management</h2>

        <div style={styles.muted}>
          <p style={{ marginBottom: '1rem' }}>
            This page will provide admin and user management interfaces for viewing, editing, and
            managing player accounts and admin roles.
          </p>
          ...
          <ul style={{ margin: '0 0 1rem 1.5rem', lineHeight: '1.8' }}>
            ...
            <li>Integration with <code style={{ color: '#aaa' }}>GET /admin/users</code> API endpoints</li>
          </ul>
          <p style={{ fontSize: '0.85rem', color: '#666' }}>
            Not yet scheduled for a specific milestone. Will be implemented when admin tooling
            expands to cover user management.
          </p>
        </div>
