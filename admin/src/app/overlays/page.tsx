...
export default function OverlaysPage() {
  return (
    <main style={styles.main}>
      <h1 style={styles.heading}>🔄 Overlays</h1>

      <div style={styles.section}>
        <div style={styles.milestoneBadge}>📌 Milestone 6 — Content List Views</div>
        <h2 style={styles.sectionHeading}>Dialogue Overlay Browser</h2>

        <div style={styles.muted}>
          <p style={{ marginBottom: '1rem' }}>
            This page will provide a read-only browser for all dialogue overlays, showing overlay type,
            associated dialogue trees, node modifications, and YAML preview.
          </p>
          <p style={{ marginBottom: '1rem', fontSize: '0.9rem' }}>
            Planned features:
          </p>
          <ul style={{ margin: '0 0 1rem 1.5rem', lineHeight: '1.8' }}>
            <li>Table of all overlays with type, dialogue reference, and node count columns</li>
            <li>Filter by overlay type or associated dialogue</li>
            <li>Click-through to overlay detail with modification diff view</li>
            <li>Integration with <code style={{ color: '#aaa' }}>GET /admin/overlays</code> API endpoint</li>
          </ul>
