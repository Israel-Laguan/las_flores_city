...
export default function DialoguesPage() {
  return (
    <main style={styles.main}>
      <h1 style={styles.heading}>💬 Dialogues</h1>

      <div style={styles.section}>
        <div style={styles.milestoneBadge}>📌 Milestone 6 — Content List Views</div>
        <h2 style={styles.sectionHeading}>Dialogue Tree Browser</h2>

        <div style={styles.muted}>
          <p style={{ marginBottom: '1rem' }}>
            This page will provide a read-only browser for all dialogue trees, showing node counts,
            beat associations, character references, and YAML preview.
          </p>
          <p style={{ marginBottom: '1rem', fontSize: '0.9rem' }}>
            Planned features:
          </p>
          <ul style={{ margin: '0 0 1rem 1.5rem', lineHeight: '1.8' }}>
            <li>Table of all dialogue trees with node count, character, and beat columns</li>
            <li>Filter by character, beat, or dialogue type</li>
            <li>Click-through to dialogue detail with node tree visualization</li>
            <li>Integration with <code style={{ color: '#aaa' }}>GET /admin/dialogues</code> API endpoint</li>
          </ul>
