...
export class PhoneOverlay {
    ...
    bridge;
    constructor() {
        this.viewport = document.getElementById('phone-app-viewport');
        this.navBar = document.getElementById('phone-nav-bar');
    ...
    updateTBDisplay(remaining) {
        const tbHeader = document.getElementById('phone-tb-display');
        if (tbHeader)
            tbHeader.textContent = `FEED — TB: ${remaining}/48`;
