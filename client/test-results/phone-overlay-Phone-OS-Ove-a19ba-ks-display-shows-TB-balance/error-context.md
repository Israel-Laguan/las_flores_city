...
- Name: phone-overlay.spec.ts >> Phone OS Overlay >> Time Blocks display shows TB balance
- Location: tests/e2e/phone-overlay.spec.ts:65:3
...
Locator: locator('#phone-tb-display')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#phone-tb-display')
