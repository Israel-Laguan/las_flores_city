...
- Name: phaser-canvas.spec.ts >> Phaser Canvas >> Game canvas is rendered
- Location: tests/e2e/phaser-canvas.spec.ts:4:3
...
Locator: locator('#game-container').locator('canvas')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#game-container').locator('canvas')
