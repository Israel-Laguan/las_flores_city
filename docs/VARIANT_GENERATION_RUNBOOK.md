...
- **`sunset`** `5:3` → `acuario__sunset.png`
...
### `aeropuerto`
- **`night`** `5:3` → `aeropuerto__night.png`
...
- **`sunset`** `5:3` → `aeropuerto__sunset.png`
...
### `apartment`
- **`night`** `5:3` → `apartment__night.png`
...
- **`sunset`** `5:3` → `apartment__sunset.png`
...
### `central_plaza`
- **`night`** `5:3` → `central_plaza__night.png`
...
- **`sunset`** `5:3` → `central_plaza__sunset.png`
...
### `estacion_central`
- **`night`** `5:3` → `estacion_central__night.png`
...
- **`sunset`** `5:3` → `estacion_central__sunset.png`
...
### `far_south`
- **`night`** `5:3` → `far_south__night.png`
...
- **`sunset`** `5:3` → `far_south__sunset.png`
...
### `industrial`
- **`night`** `5:3` → `industrial__night.png`
...
- **`sunset`** `5:3` → `industrial__sunset.png`
...
- **`night`** `5:3` → `la_casa_de_la_musica__night.png`
...
- **`sunset`** `5:3` → `la_casa_de_la_musica__sunset.png`
...
### `los_andes`
- **`night`** `5:3` → `los_andes__night.png`
...
- **`sunset`** `5:3` → `los_andes__sunset.png`
...
### `northeast`
- **`night`** `5:3` → `northeast__night.png`
...
- **`sunset`** `5:3` → `northeast__sunset.png`
...
### `old_town_cafe`
- **`night`** `5:3` → `old_town_cafe__night.png`
...
- **`sunset`** `5:3` → `old_town_cafe__sunset.png`
...
- **`sunset`** `5:3` → `pacific__sunset.png`
...
### `parque_atracciones`
- **`night`** `5:3` → `parque_atracciones__night.png`
...
- **`sunset`** `5:3` → `parque_atracciones__sunset.png`
...
- **`night`** `5:3` → `rainy_street_motorcycle__night.png`
...
- **`sunset`** `5:3` → `rainy_street_motorcycle__sunset.png`
...
- **`day`** `5:3` → `rainy_street_motorcycle__day.png`
...
### `school_classroom`
- **`night`** `5:3` → `school_classroom__night.png`
...
- **`sunset`** `5:3` → `school_classroom__sunset.png`
...
- **`day`** `5:3` → `school_classroom__day.png`
...
- **`night`** `5:3` → `secondary_city_sunset__night.png`
...
- **`day`** `5:3` → `secondary_city_sunset__day.png`
...
### `southeast`
- **`night`** `5:3` → `southeast__night.png`
...
- **`sunset`** `5:3` → `southeast__sunset.png`
...
### `the_apartment`
- **`night`** `5:3` → `the_apartment__night.png`
...
- **`sunset`** `5:3` → `the_apartment__sunset.png`
...
- **`day`** `5:3` → `the_apartment__day.png`
...
### `welcome_center`
- **`night`** `5:3` → `welcome_center__night.png`
...
- **`sunset`** `5:3` → `welcome_center__sunset.png`
...
- **`day`** `5:3` → `welcome_center__day.png`
