...
type: background
size: 1280x768
source: docs/lore/districts/city/landmarks/casa_de_la_musica/casa_de_la_musica.md
target: `scene.background_url` in `content/locations/location_casa_de_la_m_sica.yaml`
consumer: html-background
---


# Prompt: Casa de la Música

[CONSUMER: html-background]
**Type:** background
**Source:** docs/lore/districts/casa_de_la_m_sica.md
**Target field:** `scene.background_url` in `content/locations/location_casa_de_la_m_sica.yaml`
**Tool:** NIM (draft) → Flux/Seedance (refine)
**Pipeline stage:** draft → refine

## Prompt (Draft)
Casa de la Música in Las Flores, night, neo-classical with modern elements architecture. Warm artificial streetlight glow casting long soft shadows, neon signs reflecting off wet pavement, deep blue twilight sky. No people, no text, no logos.. photorealistic portrait, hyper-detailed, grounded human anatomy with natural asymmetry, 8k. NO photorealistic, 3D render, anime, cartoon, text, watermarks, blurry, low quality, photorealistic, 3D render, Pixar, Disney, comic book, manga screentones, cel shading, heavy outlines, oversaturated colors, rough sketch, watercolor, oil painting, grain, noise, plastic skin, overly glossy skin, hyper detailed pores, HDR, harsh side shadows, runway models, chiseled flawless faces, identical facial features, clone appearance, holographic tech, glowing clothi...

## Prompt
Casa de la Música in Las Flores, night, neo-classical with modern elements architecture. Premium contemporary graphic novel realism, refined editorial line art illustration, painterly soft shading, muted desaturated colors, smooth gradients, crisp rendering, minimal surface texture, ultra-clean 4k. Warm artificial streetlight glow casting long soft shadows, neon signs reflecting off wet pavement, deep blue twilight sky. No people, no text, no logos.
