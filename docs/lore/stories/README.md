...
> This directory contains standalone narrative pieces that enrich the Las Flores 2077 world.

## Index

| Story | Key Figures | Tags |
|---|---|---|
| [The Abandoned Mine Across the River](the_abandoned_mine.md) | Diego, Mina Escondida | `#mining` `#history` `#old_las_flores` |
| [Jianhua's Unusual Fascination](jianhua_fascination.md) | Jianhua | `#chinese_community` `#indigenous` `#culture` |
| [Xue's Late Epiphany](xue_late_epiphany.md) | Xue, Kusi | `#chinese_community` `#love` `#restaurant` |
| [The Forgotten Miner](the_forgotten_miner.md) | Wei Li (miner) — ✅ RESOLVED | `#mining` `#chinese_community` `#resolved_li_wei` |
| [The Unsung Odyssey of Yang Chen](unsung_odyssey_yang_chen.md) | Yang Chen | `#lw_group` `#chinese_community` `#legacy` |
| [The Great Migration to Las Flores](great_migration.md) | Jorge, Carlos, Ana | `#migration` `#demography` `#latin_american` |
| [Sofia's Unyielding Spirit](sofia_unyielding_spirit.md) | Sofia, Ariana | `#disability` `#mining` `#resilience` |
| [Mauro's Melancholy](mauro_melancholy.md) | Mauro/Kusi, La Diabla | `#indigenous` `#transportation` `#guilt` |
| [The Tides of Time](tides_of_time.md) | Carlos (port operator) | `#port` `#history` `#nostalgia` |
| [Discovery of the Lithium Vein](discovery_lithium_vein.md) | Annabella van der Meer | `#dutch_interest` `#lithium` `#science` |
| [The Dutch Maneuvers](dutch_maneuvers.md) | Pieter van der Meer, Juan Pablo Ramos | `#dutch_interest` `#politics` `#constitution` |
| [Marriage of Carlos Alberto and Elisabeth](marriage_carlos_alberto.md) | Carlos Alberto Hernandez, Elisabeth van der Meer | `#politics` `#dutch_interest` `#corruption` |
| [Emilio Santos - A Fallen Politician](emilio_santos.md) | Emilio Santos | `#politics` `#corruption` `#pacific` |
| [Ricardo Vega - Party Hopper](ricardo_vega.md) | Ricardo Vega | `#politics` `#industrial` `#populism` |
| [Maria Sanchez Sulca - The Whistleblower](maria_sanchez_sulca.md) | Maria Sanchez Sulca | `#whistleblower` `#politics` `#corruption` |
| [Evidence Transport](evidence_transport.md) | Martinez, Rodriguez, Lopez, Chen, Johnson | `#trial` `#corruption` `#lithium` |
