...
**Type:** background
**Source:** docs/lore/landmarks/sendero_del_puma.md
**Target field:** `scene.background_url` in `content/locations/location_sendero_del_puma.yaml`
**Tool:** NIM (draft) → Flux/Seedance (refine)
**Pipeline stage:** draft → refine

## Prompt
Scene of Sendero Del Puma in Las Flores, night, --, warm, peaceful. Premium contemporary graphic novel realism, refined editorial line art illustration, painterly soft shading, muted desaturated colors, smooth gradients, crisp rendering, minimal surface texture, ultra-clean 4k. No people, no text, no logos, 1920×1080.
