...
**Type:** background
**Source:** docs/lore/landmarks/far_south.md
**Target field:** `scene.background_url` in `content/locations/location_far_south.yaml`
**Tool:** NIM (draft) → Flux/Seedance (refine)
**Pipeline stage:** draft → refine

## Prompt
Scene of Far South in Las Flores, daytime, --, harsh, atmospheric. Premium contemporary graphic novel realism, refined editorial line art illustration, painterly soft shading, muted desaturated colors, smooth gradients, crisp rendering, minimal surface texture, ultra-clean 4k. No people, no text, no logos, 1920×1080.
