...
**Type:** background
**Source:** docs/lore/landmarks/sierra_verde_park.md
**Target field:** `scene.background_url` in `content/locations/location_sierra_verde_park.yaml`
**Tool:** NIM (draft) → Flux/Seedance (refine)
**Pipeline stage:** draft → refine

## Prompt
Scene of Sierra Verde Park in Las Flores, dawn, --, warm, serene. Premium contemporary graphic novel realism, refined editorial line art illustration, painterly soft shading, muted desaturated colors, smooth gradients, crisp rendering, minimal surface texture, ultra-clean 4k. No people, no text, no logos, 1920×1080.
