...
**Type:** background
**Source:** docs/lore/landmarks/financial_district.md
**Target field:** `scene.background_url` in `content/locations/location_financial_district.yaml`
**Tool:** NIM (draft) → Flux/Seedance (refine)
**Pipeline stage:** draft → refine

## Prompt
Scene of Financial District in Las Flores, daytime, Banco Central de Las Flores, World Trade Center Las Flores, Bolsa de Valores de Las Flores, atmospheric, atmospheric. Premium contemporary graphic novel realism, refined editorial line art illustration, painterly soft shading, muted desaturated colors, smooth gradients, crisp rendering, minimal surface texture, ultra-clean 4k. No people, no text, no logos, 1920×1080.
