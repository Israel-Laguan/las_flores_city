...
**Type:** background
**Source:** docs/lore/landmarks/san_miguel_dam.md
**Target field:** `scene.background_url` in `content/locations/location_san_miguel_dam.yaml`
**Tool:** NIM (draft) → Flux/Seedance (refine)
**Pipeline stage:** draft → refine

## Prompt
Scene of San Miguel Dam in Las Flores, night, --, warm, peaceful. Premium contemporary graphic novel realism, refined editorial line art illustration, painterly soft shading, muted desaturated colors, smooth gradients, crisp rendering, minimal surface texture, ultra-clean 4k. No people, no text, no logos, 1920×1080.
