...
## Prompt — Base
Seamless top-down tileable texture of weathered port asphalt, Las Flores 2077, soft cyberpunk pastel palette, dark cracked tarmac with salt stains, rust streaks, faded lane markings, photorealistic, 512x512, no objects, no people, no horizon, no sky, centered square crop.
