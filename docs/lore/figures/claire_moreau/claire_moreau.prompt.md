...
type: portrait
size: 1024x1024
source: docs/lore/figures/claire_moreau/claire_moreau.md
target: `portrait_urls[].url` in `content/characters/char_claire_moreau.yaml`
consumer: portrait
---
...
[CONSUMER: portrait]
**Type:** portrait
**Source:** docs/lore/figures/claire_moreau.md
**Target field:** `portrait_urls[].url` in `content/characters/char_claire_moreau.yaml`
**Tool:** MidJourney --v 6 --ar 3:4 --style raw

## Prompt (Draft)
Premium contemporary graphic novel realism, refined editorial line art illustration, waist-up portrait of a medium-height French Photorealistic portrait of Claire Moreau. Her frame is solid and un-sculpted. She exhibits a deeply unique, un-idealized facial anatomy with realistic eye sizes, dark expressive eyes, a straight nose, and a defined jaw. Her expression is calm and determined, as she meets the viewer with steady, composed bearing. Her dark hair hair is grouped into simple, un-styled flowing shapes. A small sport non-in-ear earbud is clipped firmly to her earlobe. She wears a minimalist, pocketless practic. photorealistic portrait, hyper-detailed, grounded human anatomy with natural asymmetry, 8k. NO photorealistic, 3D render, anime, cartoon, text, watermarks, blurry, low quality...
