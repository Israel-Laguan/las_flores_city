...
type: portrait
size: 1024x1024
source: docs/lore/figures/ricardo_chen/ricardo_chen.md
...
[CONSUMER: portrait]
**Type:** portrait
**Source:** docs/lore/figures/ricardo_chen.md
**Target field:** `portrait_urls[].url` in `content/characters/char_ricardo_chen.yaml`
