...
[CONSUMER: portrait]
**Type:** portrait
**Source:** docs/lore/figures/mateo_vargas.md
**Target field:** `portrait_urls[].url` in `content/characters/char_mateo_vargas.yaml`
...
## Variations
- [ ] Action shot: Mateo Vargas in their element
- [ ] Emotional: Mateo Vargas in a quiet moment
- [ ] Group: Mateo Vargas with their closest allies
