...
type: portrait
size: 1024x1024
source: docs/lore/figures/emilio_navarro/emilio_navarro.md
target: `portrait_urls[].url` in `content/characters/char_emilio_navarro.yaml`
consumer: portrait
---
