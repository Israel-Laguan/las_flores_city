...
4. ~~SC-104 rollback documentation~~ — forward-only is an acceptable interim answer. ✅ Done — SC-104/README.md reference corrected to roadmap.md §5 (spike-honesty norm); 095.sql already references §4 (rollback boundary).
